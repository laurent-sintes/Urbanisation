# Reservation Policy Decision — adoption et comportements proposés
...
**U342 : nom et définition de la capacité adoptés. Les quatre comportements, leurs descriptions et le rattachement à D05 sont proposés.**
...
**Niveau de preuve.** Mécanismes de déclenchement directement documentés ; nom de regroupement FLOW proposé.
...
**Niveau de preuve.** Leviers commercetools et adaptations voisines IBM/SAP ; aucun moteur standard de sélection du jalon par risque démontré. Proposition FLOW issue de U341, sans revendication d’innovation exclusive.
...
**Parent proposé : D05 Inventory Optimization.** Compromis disponibilité, immobilisation et risque ; le choix de politique reste distinct de la satisfaction des Orders D03.
...
- Valider les quatre comportements, leurs noms et leurs frontières.
- Arbitrer D05 comme parent et le porteur de gouvernance des politiques.
