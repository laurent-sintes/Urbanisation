...
- **Application de plan (U287)** : Order Management porte un mécanisme d’application de scénario ou de plan d’allocation. Sa capacité parente précise reste à arbitrer ; ne pas créer un comportement directement sous le domaine. Distinguer part matérialisée par des Orders et configuration des droits/seuils dans Supply Protection. Définition détaillée et contrats proposés dans la cible U286.
