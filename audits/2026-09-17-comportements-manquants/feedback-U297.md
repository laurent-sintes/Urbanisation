# Logistics Visibility — nom validé
...
Nom adopté pour le parcours physique demandé U296 : du prélèvement/picking au point final, via préparation, manutention, chargement, transport et étapes intermédiaires.

U297 valide explicitement le nom. La définition éditoriale détaillée, le niveau capacité/comportement et le rattachement restent proposés ; pas de renommage de D07.d ni de suppression du suivi des services non physiques.

**Définition éditoriale proposée.** Rendre visible et traçable la progression physique des marchandises depuis leur prélèvement dans un espace de stockage jusqu’à leur remise au point de destination, à travers les opérations de préparation, de manutention, de transport et les étapes intermédiaires ; restituer localisation, quantités, état d’avancement, événements, échéances estimées et écarts.

Inventory Visibility D01.c conserve la connaissance des quantités et états ; Logistics Visibility décrit leur progression dans les opérations physiques, sans double compte ni transfert des opérations internes des exécutants.

Validation : U297 ; comparaison marché : CMP102. Catalogue et publications inchangés.
