# Track and Trace — alignement du nom sur le marché
...
Reprendre le terme établi du marché lorsque notion et périmètre correspondent ; toute déviation doit être justifiée par une innovation explicitée. Distinguer nom de produit, catégorie de marché et notion métier.

SAP : produit Global Track and Trace et notion Logistics Visibility ; Oracle : Track and Trace dans Order/Shipment Visibility ; project44/FourKites : Transportation Visibility. Les sources ne démontrent pas de nom unique Global Track.

Remplacer la proposition de nom Transit Visibility par Track and Trace, terme partagé SAP/Oracle. Il s’agit d’une proposition corrigée, pas d’un renommage adopté du catalogue.

**Définition proposée.** Suivre la localisation et la progression des marchandises et expéditions, restituer leur parcours et les événements associés, et rendre visibles les arrivées estimées et écarts utiles aux Orders concernés.

Périmètre logistique : localisation connue ou estimée, jalons datés, parcours, ETA et écarts. La continuité GPS n’est pas présumée. Execution Tracking conserve aussi les prestations sans mouvement physique.

Rattachement sous Execution Tracking toujours proposé. Les exceptions logistiques appartiennent au périmètre Track and Trace ; ne pas en créer une copie sous un second comportement sans bénéfice distinct. Le découpage doit être réexaminé avant adoption.

**Sources.** [S29 — SAP](https://www.sap.com/products/business-network/global-track-and-trace.html), [S34 — Oracle](https://docs.oracle.com/en/cloud/saas/transportation/26c/otmol/execution/giv/order_shipment_visibility_results.htm), [S35 — project44](https://www.project44.com/blog/enhancing-automotive-finished-vehicle-logistics-with-real-time-visibility/), [S36 — FourKites](https://www.fourkites.ai/blogs/evolving-beyond-traditional-visibility-evaluation-frameworks)

**Limite d’accès.** Recherche GS1 EPCIS identifiée mais ouverture refusée (403) ; non utilisée pour prétendre à une appellation normative universelle.
