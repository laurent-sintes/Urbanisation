# Inventory Visibility et visibilité du transport
...
D01.c conserve Inventory Visibility : stocks physiques, états logiques et ressources futures, avec provenance, fraîcheur et absence de double compte.

Transportation Visibility est cohérent avec le vocabulaire établi et offre un parallèle lisible avec Inventory Visibility. La proposition Track and Trace de U294 n’est pas exclusive ni adoptée.

Pour le besoin précis de suivi des marchandises en mouvement, préférer Transportation Visibility. Logistics Visibility est une option de portée plus large si le périmètre inclut les étapes logistiques autour du transport ; ce repère FLOW ne prétend pas normaliser des usages éditeurs qui se recouvrent.

Localisation et progression des marchandises pendant leur acheminement, jalons, arrivées estimées et écarts, reliés aux Orders concernés. Le choix du nom ne décide pas à lui seul du niveau capacité/comportement.

D07.d Execution Tracking couvre aussi des prestations non physiques. Aucun renommage global ni nouvelle capacité ou comportement créé. Les vues stock et transport peuvent partager les mêmes ressources et événements sans les compter deux fois.

Sources : [S29 — SAP](https://www.sap.com/products/business-network/global-track-and-trace.html), [S35 — project44](https://www.project44.com/blog/enhancing-automotive-finished-vehicle-logistics-with-real-time-visibility/), [S36 — FourKites](https://www.fourkites.ai/blogs/evolving-beyond-traditional-visibility-evaluation-frameworks)
