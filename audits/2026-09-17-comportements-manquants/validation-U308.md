# Store Visibility — nom adopté U308
...
**Nom courant :** Store Visibility. Ancien nom : Store Execution Visibility.

**Périmètre conservé.** Réception magasin, passage en réserve, mise en rayon et réassort de la surface de vente.

Parent : **Execution Tracking**. Niveau : comportement.

Execution Tracking porte déjà le sens d’exécution. Uniformiser Store Visibility avec Warehouse Visibility sans élargir aux ventes ou à toute l’activité magasin.

**Justification marché / modèle.** CMP104 : le périmètre Store Execution est documenté ; le nom composé antérieur n’était pas un intitulé normalisé. Justification du raccourcissement par cohérence FLOW, sans nouvelle prétention d’équivalence marché.
