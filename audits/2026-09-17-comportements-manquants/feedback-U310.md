...
Retenir implantation initiale et réassort continu comme politiques métier à examiner pour la décomposition de Replenishment Decision. Ne pas les identifier aux méthodes besoins nets / seuils-cibles.

**Pourquoi revoir la proposition.** Implantation prépare la disponibilité au lancement ; réassort entretient la disponibilité pendant la commercialisation. Les deux peuvent mobiliser besoins, cibles et calcul net. Un seuil déclaré ne suffit pas à conclure au Min/Max Microsoft.

**Existant et cible.** Deux saisons été/hiver selon Laurent. Découpages plus fins et capsules : possibilité future. Pas de règle de modèle limitant à deux saisons et pas de nouveau domaine de planification de saison.

**Marché.** SAP Initial Allocation et In-Season Fill-In ; RELEX initial allocation et in-season replenishment. Il s’agit de scénarios ou fonctions éditeurs, pas d’une hiérarchie métier native. Allocation retail est conservé comme terme éditeur qualifié.

[S08 — Microsoft](https://learn.microsoft.com/en-us/dynamics365/supply-chain/master-planning/planning-optimization/replenishment-methods-quantity-modification), [S51 — SAP](https://help.sap.com/docs/CARAB/00197153997746b4bec2020d00e66ea9/e99798c39a3f4956bd5ce509b39382f7.html?locale=en-US&state=PRODUCTION&version=5.0.2), [S52 — RELEX](https://www.relexsolutions.com/solutions/automatic-replenishment-system/)

**Frontières.** D05 décide des quantités/dates des apports ; D04 gère les Orders ; D06 et les exécutants organisent/réalisent les prestations. Les choix de collection et d’assortiment restent des entrées, sans élargissement implicite au domaine de planification de saison. La distribution contrainte entre demandes peut mobiliser Supply Assignment sans rendre l’implantation synonyme d’affectation.

**Conséquence pour l’audit.** P01/P02 ne se traduisent pas un à un par Implantation/Réassort. Réexaminer leur découpage ; conserver les mécanismes de calcul utiles dans les descriptions. P03 reste une question transverse aux deux politiques. Les libellés anglais et la décomposition complète ne sont pas adoptés.

Termes ajoutés au glossaire métier ; aucun nouveau nœud de capacité ou comportement.
