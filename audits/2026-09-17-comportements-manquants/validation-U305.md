# Visibilité logistique — accord U305
...
Noms, périmètres présentés, rattachement direct et absence de niveau supplémentaire. La décomposition de la visibilité numérique reste à instruire.

Parent : **Execution Tracking**. Niveau : comportement.

| Comportement adopté | Périmètre adopté |
| --- | --- |
| Warehouse Visibility | Réception, manutention, préparation et expédition dans les entrepôts et plateformes. |
| Transportation Visibility | Acheminements, progression, arrivées estimées et remise au destinataire. |
| Store Execution Visibility | Réception magasin, passage en réserve, mise en rayon et réassort de la surface de vente. |

Logistics Visibility : Notion englobante, sans niveau supplémentaire.

**Bénéfice magasin.** Livré au magasin ne signifie pas accessible au client en rayon. Rendre visibles la rupture en rayon malgré le stock en réserve et l’avancement des opérations nécessaires.

Nœuds BHV079–081 intégrés U406 ; valeurs et empreintes de l’accord historique préservées. Aucune publication.
